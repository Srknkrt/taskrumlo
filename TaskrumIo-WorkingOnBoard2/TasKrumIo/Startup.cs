        ...
        .AddRazorPagesOptions(options =>
              {
                  ...
                  options.Conventions.AuthorizeFolder("/BoardList");
                  /* 
            ...
            services.AddDbContext<TasKrumIoContext>(options =>
                   options.UseSqlServer(
                       Configuration.GetConnectionString("TasKrumIoContextConnection")));
